...
import { Backpack, BookOpen, CalendarDays, ChevronDown, ChevronRight, Download, ListFilter, Map as MapIcon, MapPin, MoreHorizontal, MoreVertical, Plane, Receipt, Search, Settings, ShieldCheck, Train, UtensilsCrossed, Users } from "lucide-react";
...
const views: { value: ViewMode; label: string; icon: typeof CalendarDays }[] = [
  { value: "itinerary", label: "行程", icon: CalendarDays }, { value: "map", label: "地图", icon: MapIcon },
